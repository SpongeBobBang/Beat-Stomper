...
class Pong(Frame):
    def createWidgets(self):
        ...
        self.five_ball = self.draw.create_oval("8.0i", "3.0i", "9.0i", "4.0i",
                                                 fill='gray')
        self.lalala = self.draw.create_rectangle("1.0i","0.9i","2.5i","0.9i",fill='green')
        ...
        self.second_ball_v_x = 0.6
        self.second_ball_v_y = 0.0

        self.three_ball_x = 4.5
        self.three_ball_y = 4.5
        self.three_ball_v_x = 0.7
        self.three_ball_v_y = 0.0

        self.four_ball_x = 6.5
        self.four_ball_y = 2.5
        self.four_ball_v_x = 0.4
        self.four_ball_v_y = 0.0

        self.five_ball_x = 8.5
        self.five_ball_y = 3.5
        self.five_ball_v_x = 0.9
        self.five_ball_v_y = 0.0
