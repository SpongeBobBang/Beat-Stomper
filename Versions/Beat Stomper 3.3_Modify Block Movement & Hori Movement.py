...
class Main(Frame):
    ...
    def Move_Block(self,*args):
        ...
        if self.__Fst_Press == False:
            ...
            '''
            print(self.Plank_Loc_X[0]-self.Block_X*self.Scaling,self.Plank_Loc_Y[0]-self.Block_Y*self.Scaling,self.Plank_Loc_X[0],self.Plank_Loc_Y[0],self.Block_X*self.Scaling,self.Block_Y*self.Scaling)
            '''
            ...
            '''
        self.draw.move(self.Block,self.Plank_Loc_X[0]-(self.Block_X)*self.Scaling,0)
        self.Block_X = round((self.Plank_Loc_X[0])/self.Scaling,2)
