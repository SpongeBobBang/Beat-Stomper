...
class Main(Frame):
    ...
    def Load_Planks(self,*args):
        ...
        self.first_x= round(uniform(0.9,4.5)*self.scaling,1)
        self.first_y=8.0*self.scaling
        self.first_vx=0.15*self.scaling
        self.first_vy=2
        
        self.second_x=round(uniform(0.9,4.5)*self.scaling,1)
        self.second_y=4.8*self.scaling
        self.second_vx=0.15*self.scaling
        self.second_vy=2

        self.third_x=round(uniform(0.9,4.5)*self.scaling,1)
        ...
        '''
        self.first_rec = self.Load_Plank(self.first_x/self.scaling,8.0,1.8,0.5,"blue")
        self.second_rec = self.Load_Plank(self.second_x/self.scaling,4.8,1.8,0.5,"red")
        self.third_rec = self.Load_Plank(self.third_x/self.scaling,1.6,1.8,0.5,"yellow")       
